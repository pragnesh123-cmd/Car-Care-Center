/*! nouislider - 14.5.0 - 5/11/2020 */ ! function(t) { "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? module.exports = t() : window.noUiSlider = t() }(function() {
    "use strict";
    var lt = "14.5.0";
    ...
    function C(t, e) { if (!o(e)) throw new Error("noUiSlider (" + lt + "): 'limit' option must be numeric."); if (t.limit = t.spectrum.getDistance(e), !t.limit || t.handles < 2) throw new Error("noUiSlider (" + lt + "): 'limit' option is only supported on linear sliders with 2 or more handles.") }
    ...
    function V(t, e) { h(t.ariaFormat = e) }

    function k(t, e) { h(t.format = e) }

    function D(t, e) { if ("boolean" != typeof(t.keyboardSupport = e)) throw new Error("noUiSlider (" + lt + "): 'keyboardSupport' option must be a boolean.") }
    ...
    function vt(e) {
        var r = { margin: 0, limit: 0, padding: 0, animate: !0, animationDuration: 300, ariaFormat: u, format: u },
            n = { step: { r: !1, t: m }, start: { r: !0, t: v }, connect: { r: !0, t: w }, direction: { r: !0, t: P }, snap: { r: !1, t: x }, animate: { r: !1, t: b }, animationDuration: { r: !1, t: S }, range: { r: !0, t: g }, orientation: { r: !1, t: y }, margin: { r: !1, t: E }, limit: { r: !1, t: C }, padding: { r: !1, t: N }, behaviour: { r: !0, t: U }, ariaFormat: { r: !1, t: V }, format: { r: !1, t: k }, tooltips: { r: !1, t: A }, keyboardSupport: { r: !0, t: D }, documentElement: { r: !1, t: M }, cssPrefix: { r: !0, t: O }, cssClasses: { r: !0, t: L } },
            i = { connect: !1, direction: "ltr", behaviour: "tap", orientation: "horizontal", keyboardSupport: !0, cssPrefix: "noUi-", cssClasses: d };
        e.format && !e.ariaFormat && (e.ariaFormat = e.format), Object.keys(n).forEach(function(t) {
            if (!a(e[t]) && void 0 === i[t]) { if (n[t].r) throw new Error("noUiSlider (" + lt + "): '" + t + "' is required."); return !0 }
    ...
    function z(t, v, o) {
        ...
        function k(t, e) { var r = w.createElement("div"); return e && ht(r, e), t.appendChild(r), r }

        function D(t, e) {
            var r = k(t, v.cssClasses.origin),
                n = k(r, v.cssClasses.handle);
            return k(n, v.cssClasses.touchArea), n.setAttribute("data-handle", e), v.keyboardSupport && (n.setAttribute("tabindex", "0"), n.addEventListener("keydown", function(t) {
                return function(t, e) {
                    if (O() || L(e)) return !1;
                    var r = ["Left", "Right"],
                        n = ["Down", "Up"],
                    ...
                    if (t.preventDefault(), p || c) {
                        var h = c ? 0 : 1,
                            ...
                            g = m[h];
                        if (null === g) return !1;
                        !1 === g && (g = y.getDefaultStep(b[e], c, 10)), (u || l) && (g *= 5), g = Math.max(g, 1e-7), g *= c ? -1 : 1, s = x[e] + g
        ...
        function M(t, e) { return !!e && k(t, v.cssClasses.connect) }

        function r(t, e) { return !!v.tooltips[e] && k(t.firstChild, v.cssClasses.tooltip) }
        ...
        function j(e, i, o) {
            var s = w.createElement("div"),
                a = [];
            a[P] = v.cssClasses.valueNormal, a[U] = v.cssClasses.valueLarge, a[A] = v.cssClasses.valueSub;
            var l = [];
            l[P] = v.cssClasses.markerNormal, l[U] = v.cssClasses.markerLarge, l[A] = v.cssClasses.markerSub;
            ...
            return ht(s, v.cssClasses.pips), ht(s, 0 === v.ort ? v.cssClasses.pipsHorizontal : v.cssClasses.pipsVertical), Object.keys(e).forEach(function(t) {
                ! function(t, e, r) {
                    if ((r = i ? i(e, r) : r) !== N) {
                        var n = k(s, !1);
                        n.className = p(r, v.cssClasses.marker), n.style[v.style] = t + "%", P < r && ((n = k(s, !1)).className = p(r, v.cssClasses.value), n.setAttribute("data-value", e), n.style[v.style] = t + "%", n.innerHTML = o.to(e))
                    }
                }(t, e[t][0], e[t][1])
            }), s
        }
        ...
        function R(t) {
            F();
            var m, g, v, x, e, r, b, S, w, n = t.mode,
                i = t.density || 1,
                o = t.filter || !1,
                s = function(t, e, r) {
                ...
                a = (m = i, g = n, v = s, x = {}, e = y.xVal[0], r = y.xVal[y.xVal.length - 1], S = b = !1, w = 0, (v = v.slice().sort(function(t, e) { return t - e }).filter(function(t) { return !this[t] && (this[t] = !0) }, {}))[0] !== e && (v.unshift(e), b = !0), v[v.length - 1] !== r && (v.push(r), S = !0), v.forEach(function(t, e) {
                    var r, n, i, o, s, a, l, u, c, p, f = t,
                        d = v[e + 1],
                        h = "steps" === g;
                    if (h && (r = y.xNumSteps[e]), r || (r = d - f), !1 !== f && void 0 !== d)
                        for (r = Math.max(r, 1e-7), n = f; n <= d; n = (n + r).toFixed(7) / 1) {
                            for (u = (s = (o = y.toStepping(n)) - w) / m, p = s / (c = Math.round(u)), i = 1; i <= c; i += 1) x[(a = w + i * p).toFixed(5)] = [y.fromStepping(a), 0];
                            l = -1 < v.indexOf(n) ? U : h ? A : P, !e && b && n !== d && (l = 0), n === d && S || (x[o.toFixed(5)] = [n, l]), w = o
                        }
                }), x),
        ...
        function B(n, i, o, s) {
            var e = function(t) {
                    ...
                    }(t, s.pageOffset, s.target || i)) && (!(O() && !s.doNotReject) && (e = h, r = v.cssClasses.tap, !((e.classList ? e.classList.contains(r) : new RegExp("\\b" + r + "\\b").test(e.className)) && !s.doNotReject) && (!(n === f.start && void 0 !== t.buttons && 1 < t.buttons) && ((!s.hover || !t.buttons) && (d || t.preventDefault(), t.calcPoint = t.points[v.ort], void o(t, s))))));
                    var e, r
                },
                r = [];
        ...
        function q(t) { var e, r, n, i, o, s, a = 100 * (t - (e = l, r = v.ort, n = e.getBoundingClientRect(), i = e.ownerDocument, o = i.documentElement, s = gt(i), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (s.x = 0), r ? n.top + s.y - o.clientTop : n.left + s.x - o.clientLeft)) / T(); return a = ft(a), v.dir ? 100 - a : a }
        ...
        function I(t, e) {
            ...
            t.stopPropagation();
            var n = [],
                i = B(f.move, E, Y, { target: t.target, handle: r, listeners: n, startCalcPoint: t.calcPoint, baseSize: T(), pageOffset: t.pageOffset, handleNumbers: e.handleNumbers, buttonsProperty: t.buttons, locations: b.slice() }),
            ...
            n.push.apply(n, i.concat(o, s)), t.cursor && (C.style.cursor = getComputedStyle(t.target).cursor, 1 < u.length && ht(h, v.cssClasses.drag), C.addEventListener("selectstart", ct, !1)), e.handleNumbers.forEach(function(t) { J("start", t) })
        }
        ...
        function W(t) {
            var e = q(t.calcPoint),
                r = y.getStep(e),
                n = y.fromStepping(r);
            Object.keys(S).forEach(function(t) { "hover" === t.split(".")[0] && S[t].forEach(function(t) { t.call(a, n) }) })
        }
        ...
        function rt(t, e, r, n) {
            return !1 !== (e = K(b, t, e, r, n, !1)) && (function(t, e) {
        ...
        function it(t, e) { return null === t || !1 === t || void 0 === t ? b[e] : ("number" == typeof t && (t = String(t)), t = v.format.from(t), !1 === (t = y.toStepping(t)) || isNaN(t) ? b[e] : t) }

        function ot(t, e) {
            var r = dt(t),
                n = void 0 === b[0];
            e = void 0 === e || !!e, v.animate && !n && pt(h, v.cssClasses.tap, v.animationDuration), m.forEach(function(t) { rt(t, it(r[t], t), !0, !1) });
            for (var i = 1 === m.length ? 0 : 1; i < m.length; ++i) m.forEach(function(t) { rt(t, b[t], !0, !0) });
            et(), m.forEach(function(t) { J("update", t), null !== r[t] && e && J("set", t) })
        }

        function st() { var t = x.map(v.format.to); return 1 === t.length ? t[0] : t }
        ...
        return ht(e = h, v.cssClasses.target), 0 === v.dir ? ht(e, v.cssClasses.ltr) : ht(e, v.cssClasses.rtl), 0 === v.ort ? ht(e, v.cssClasses.horizontal) : ht(e, v.cssClasses.vertical), ht(e, "rtl" === getComputedStyle(e).direction ? v.cssClasses.textDirectionRtl : v.cssClasses.textDirectionLtr), l = k(e, v.cssClasses.base),
            function(t, e) {
                var r = k(e, v.cssClasses.connects);
                u = [], (s = []).push(M(r, t[0]));
                for (var n = 0; n < v.handles; n++) u.push(D(e, n)), m[n] = n, s.push(M(r, t[n + 1]))
            }(v.connect, l), (p = v.events).fixed || u.forEach(function(t, e) { B(f.start, t.children[0], I, { handleNumbers: [e] }) }), p.tap && B(f.start, l, n, {}), p.hover && B(f.move, l, W, { hover: !0 }), p.drag && s.forEach(function(t, e) {
            ...
            }), ot(v.start), v.pips && R(v.pips), v.tooltips && H(), $("update", function(t, e, s, r, a) {
                m.forEach(function(t) {
                    var e = u[t],
                        r = K(b, t, 0, !0, !0, !0),
                        n = K(b, t, 100, !0, !0, !0),
                ...
                __moveHandles: function(t, e, r) { Z(t, e, b, r) },
                options: o,
                updateOptions: function(e, t) {
                    ...
                    var i = vt(o);
                    n.forEach(function(t) { void 0 !== e[t] && (v[t] = i[t]) }), y = i.spectrum, v.margin = i.margin, v.limit = i.limit, v.padding = i.padding, v.pips ? R(v.pips) : F(), v.tooltips ? H() : z(), b = [], ot(e.start || r, t)
                },
                target: h,
                removePips: F,
                removeTooltips: z,
    ...
    return { __spectrum: i, version: lt, cssClasses: d, create: function(t, e) { if (!t || !t.nodeName) throw new Error("noUiSlider (" + lt + "): create requires a single element, got: " + t); if (t.noUiSlider) throw new Error("noUiSlider (" + lt + "): Slider was already initialized."); var r = z(t, vt(e), e); return t.noUiSlider = r } }
});